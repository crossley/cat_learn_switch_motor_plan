# Category Learning During Task Switching (Switch Motor Plan 1)

This subdirectory contains the original study (`switch_motor_plan_1`) within the combined repository.
